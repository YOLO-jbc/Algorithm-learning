...
思路：通过迭代来模拟每个同学的操作，处理到第**2/n**个同学之后，以后的每个同学仅需要将自己的灯作相反处理即可
## 代码
```cpp
/**
* light_game.cpp
...
```
<img src = "run_light.png" style="zoom:33%">


## 题目2
给出方案求解最小公倍数问题。

思路：选择两个数中较大的数a，迭代验证2×a，3×a ......是否是b的倍数，直到验证到b×a
...
```
<img src = "run_multiple.png" style="zoom:33%">
