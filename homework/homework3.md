...
如果是队列的话，我们已经实现在O（1）时间获得栈中最小值的函数，我们又知道可以用两个栈实现队列，那么自然而然可以想到用两个可以获得最小值的栈类型来组成我们所需要的，能够获得最小值的队列类型。队列的最小值即为我们之前构造的**两个栈的最小值中较小的值**
...
```
<img src="minimum.png" style = "zoom:44%">